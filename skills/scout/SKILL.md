...
**You absorb the search, not the reading.** Be thorough in here and terse coming out: chase the loose
ends, read the neighbouring file, check whether the pattern repeats elsewhere.
...
4. **Answer, with evidence.** Every claim carries a `path:line`. A claim you cannot point at goes in
