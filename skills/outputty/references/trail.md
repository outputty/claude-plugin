...
through `bun skills/outputty/docs.js trail <branch> --section <name> [--json]` instead of a whole-file
read.
...
decisions:
  ...
  - question: <the question, named>
    ...
    link: <the doc/PR/line this is filed under, e.g. "product.md §3" or "hooks/require-grill.js:56">
