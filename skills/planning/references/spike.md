...
The planning skill points here from its Spike section. A spike is a test in the repo's own suite that answers an empirical question; a deletion is a spike too.
