...
1. **This project** - one line in the matching `.claude/rules/<topic>.md`: the moment, the action, the date. `- After a rename, git grep prose for the old name before the commit. (2026-08-28)`
