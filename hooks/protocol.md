...
**`lessons.md`** (the past — repeat work, or when stuck). A monolithic `product.md` is pre-split
legacy: split it at the next merge step. **Every ✅-shipped claim in these docs was verified by a run**
— hold anything you add to the same bar. Canonical shape:
