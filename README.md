...
Corrections go to `.claude/rules/` as one line each, at two moments: after `/plan` files, and inside every build's docs layer. Machine-level facts go to auto-memory. Nothing else remembers anything.
