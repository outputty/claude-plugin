...
- **A hands-off build loop** drains a dependency-ordered task graph (see [Task tracking](#task-tracking)):
  ...
  Failures climb a four-try ladder — Sonnet patch, Sonnet full rewrite, an Opus step-back over the whole
