...
<!-- One concept per example, code first. The first example is the pipeline from architecture.md. Real input values, real output from a run; an output that was not run is labelled expected. -->
