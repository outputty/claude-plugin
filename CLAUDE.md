...
- **Fast-path fix** - a ticket whose picked spike already is the complete fix; `/plan` ships it as its own PR, stacked under the docs PR, instead of handing off to a build session. (new)
