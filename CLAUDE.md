...
2. **Pick** - `claude --worktree ticket-<n>`, then `/tickets`: it lists what is open with blockers and priority, and prints the `/goal` line for the one to build. You paste it.
